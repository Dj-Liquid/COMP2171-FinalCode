        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="Room_Assignment.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Room Assignment</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Room Assignment </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="container" style="padding-top:100px">
       <center> 
        <form action="Room_Assignment.php" method="get" style="width:300px">
...
$result='';
 if(isset($_GET['search'])){
  ...
  $name= $_GET['search'] ;
  $result= UI::searchResidents($conn,$name);
  }else{
...
$result=UI::showAcceptedApplications($conn);
  ...
  <tr>
    ...
    <td><?=$gender?></td>
    <td><?=$roomtype?></td>
    <td><a href="Room_Assignment.php?assign=<?=$id?>" class="btn btn-success">Assign Room</a>
    </td>
  </tr>
